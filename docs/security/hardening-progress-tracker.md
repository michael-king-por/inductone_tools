...
| InductOne CSA full lifecycle smoke | Complete in candidate | Added `scripts/run_inductone_csa_lifecycle_smoke.py` and executed a synthetic candidate build cloned from `SAL-ORD-2026-00054-BLD-0225` through snapshot, hierarchy workbook, Configuration Order, BOM Export Package, top-BOM signoff, serial allocation, release to builder, builder acknowledgement, completion workbook upload, review, acceptance, locked As-Built creation, and Instance creation. Evidence: `inductone_csa_lifecycle_smoke_20260709T171616Z.json`; final records `SAL-ORD-2026-00054-BLD-0455`, `SAL-ORD-2026-00054-BLD-0455-CO-457`, `SAL-ORD-2026-00054-BLD-0455-COMP-459`, `SAL-ORD-2026-00054-BLD-0455-ASBUILT-460`, Instance `IND-3006`. Gate found and fixed retired `flat_bom_status = Pending` in the CO after-insert hook and missing Instance component-serial propagation from accepted As-Built serials. Documentation: `docs/workflows/inductone-csa-lifecycle-smoke-2026-07-09.md`. Follow-up acknowledgement hardening is tracked in the next row and is now complete. |
