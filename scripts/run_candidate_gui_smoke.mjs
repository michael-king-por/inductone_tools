...
const personas = [
  {
    ...
    checks: [
      ...
      access("Home workspace denied/hidden", "/app/home", false, false),
      access("Stock workspace denied/hidden", "/app/stock", false, false),
      access("Financial Reports workspace denied/hidden", "/app/financial-reports", false, false),
      access("Manufacturing workspace denied/hidden", "/app/manufacturing", false, false),
      access("Payables workspace denied/hidden", "/app/payables", false, false),
      access("Receivables workspace denied/hidden", "/app/receivables", false, false),
      access("Selling workspace denied/hidden", "/app/selling", false, false),
      access("Welcome Workspace denied/hidden", "/app/welcome-workspace", false, false),
